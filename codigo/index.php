			...
			<form name="entrada" action="codigo/comandos_sql.php" method="POST">
				...
				<table width=22% align="center" border="0">
						...
						<tr>							
							...
							<td width="4"><center><img src="imagens/selecionar.png" title="Clique para selecionar uma Entrada de Docoumento"></center></td>
							<td width="15">Entrada de Documento</td>
						</tr>
						<tr>
							<td width="4">
							<input type="radio" name="processo" value="PEE">
							<td width="4"><center><img src="imagens/selecionar.png" title="Clique para selecionar uma Entrada de Exame"></center></td>
